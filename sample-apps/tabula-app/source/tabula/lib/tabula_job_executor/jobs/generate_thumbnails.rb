...
class GenerateThumbnailJob < Tabula::Background::Job
  # args: (:file, :password, :output_dir, :thumbnail_sizes, :page_index_job_uuid)
  ...
  def perform
    ...
    generator = PDFBoxThumbnailGenerator.new(filepath, password, output_dir, file_id, thumbnail_sizes)
