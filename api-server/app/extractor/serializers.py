...
class DatastoreInfoListSerializer(serializers.ModelSerializer):
    class Meta():
        model = DatastoreInfo
        fields = ('id', 'title', 'type', 'parameters')
        read_only_fields = ('id',)
...
class DatastoreInfoDetailSerializer(serializers.ModelSerializer):
    class Meta():
        model = DatastoreInfo
        fields = ('id', 'title', 'type', 'parameters')
        read_only_fields = ('id',)
...
class DatastoreTypeListSerializer(serializers.ModelSerializer):
    class Meta():
        model = DatastoreType
...
class DatastoreTypeDetailSerializer(serializers.ModelSerializer):
    class Meta():
        model = DatastoreType
        fields = ('id', 'title', 'parameters')
        read_only_fields = ('id',)
